...
import pwsa.toko.exceptions.NonexistentEntityException;
import pwsa.toko.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pwsa_toko_jar_0.0.1-SNAPSHOTPU");
